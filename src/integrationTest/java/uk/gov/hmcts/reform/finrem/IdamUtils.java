...
import uk.gov.hmcts.reform.finrem.model.CreateUserRequest;
import uk.gov.hmcts.reform.finrem.model.UserCode;
...
public class IdamUtils {
    ...
    private void createUserInIdam(String username, String password) {
        CreateUserRequest userRequest = CreateUserRequest.builder()
            ...
            .userGroup(UserCode.builder().code("finrem-private-beta").build())
            .build();
